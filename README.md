...
The "NIPTS user function" is a supporting function app that processes and retrieves user details for the NIPTS service applied via the NIPTS Application Portal.
...
```
git clone https://github.com/DEFRA/nipts-pts-user-functions.git
cd nipts-pts-user-functions
```
